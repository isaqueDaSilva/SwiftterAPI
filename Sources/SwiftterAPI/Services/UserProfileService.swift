...
enum UserProfileService {
    ...
    /// - Parameters:
    ///   - slug: A slug value for add as identifier at the profile of the user.
    ...
    static func create(with slug: String, userID: String, at database: any Database) async throws -> UserProfile {
        let newProfile = UserProfile(id: slug, userID: userID)
