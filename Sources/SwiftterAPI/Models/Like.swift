...
final class Like: Model, @unchecked Sendable {
    ...
    ///
    /// This identifier is composed by the slug of the user and the id of the swifeet. With this, is possible to apply a constraint that restrict the same user to like the same post twice, since this identifier needs to be unique for each like.
    ///
    ...
    @Parent(key: FieldName.userSlug.key)
